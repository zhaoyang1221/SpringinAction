...
/**
 * <p>Title: SpittleControllerTest</p>
 *
 * @description: 测试类
 * @author: xiongzy
 * @date: 2018-10-22
...
public class SpittleControllerTest {
    ...
    public void shouldShowPageSpittles() throws Exception {
        ...
        mockMvc.perform(get("/spittles?max=238900&count=50"))
                .andExpect(view().name("spittles"))  // 校验视图名
                .andExpect(model().attributeExists("spittleList")) // 校验模型中属性名是否存在
                .andExpect(model().attribute("spittleList", hasItems(expectedSpittles.toArray()))); // 校验模型中list的每个值
    }
